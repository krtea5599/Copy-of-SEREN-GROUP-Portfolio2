...
export const PILLARS: Project[] = [
  ...
  },
  {
    ...
    category: "EDUCATION",
    title: "3. AI 엄마학교",
    description: "엄마들의 성장이 곧 미래 교육의 혁신이라는 믿음으로 운영하는 교육 브랜드입니다.",
    fullDescription: "학부모와 교육 종사자를 대상으로 'AI와 함께 작가가 되는 과정'을 교육합니다. 지식의 자산화를 통해 엄마들의 성장을 지원합니다.",
    achievements: [
      "전국 평생학습 수강생 대상 '세렌 작가' 과정 운영",
      "'내 아이 첫 특허 캠페인' 진행",
